    ...
    return (
        <div id='home' className="bg-cinzabg flex flex-col md:flex-row items-center px-4 py-10 md:px-7 py20  ">
            <div className="py-7 px-7 md:px-7 w-full md:w-[850px] space-y-5 md:space-y-10">
                ...
                <button className="bg-gray-500 text-center text-xl font-bold w-[230px] h-[90px] rounded-xl shadow-md hover:opacity-65 transition duration-300 delay-150">Fale com um Detetive</button>
            </div>
